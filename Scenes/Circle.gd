...
func draw_empty_circle(circle_center: Vector2, radius: float, color: Color, resolution: int, width: float):
	var draw_counter = 1
	var line_origin = Vector2()
	var line_end = Vector2()
	var circle_radius = Vector2(0, radius)
